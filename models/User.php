 ...
 * @property integer $belong_mch
 * @property string $province
 * @property string $city
 * @property string $district
 * @property string $longitude
 * @property string $latitude
 * @property string $membership_info_id
 */
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['account_id', 'type', 'addtime', 'is_delete', 'sex', 'store_id', 'is_distributor', 'parent_id', 'time', 'is_clerk', 'we7_uid', 'shop_id', 'level', 'integral', 'total_integral', 'platform', 'blacklist', 'parent_user_id', 'belong_mch','membership_info_id','birthday'], 'integer'],
            [['username', 'password', 'auth_key', 'access_token'], 'required'],
            [['avatar_url'], 'string'],
            [['total_price', 'price', 'money'], 'number'],
            [['username', 'password', 'auth_key', 'access_token', 'wechat_open_id', 'wechat_union_id', 'nickname', 'contact_way', 'comments', 'province', 'city', 'district', 'longitude', 'latitude'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'level' => '会员等级',
            'integral' => '用户当前积分',
            'total_integral' => '用户总获得积分',
            'money' => '余额',
            'contact_way' => '联系方式',
            'comments' => '备注',
            'binding' => '授权手机号',
            'wechat_platform_open_id' => '微信公众号openid',
            'platform' => '小程序平台 0 => 微信, 1 => 支付宝',
