 ...
 * @property integer $is_attrbute_use
 * @property integer $attrbute_id
 * @property integer $attrbute_json
...
class Goods extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'cat_id', 'status', 'addtime', 'is_delete', 'sort', 'individual_share', 'freight', 'use_attr', 'share_type', 'quick_purchase', 'hot_cakes', 'mch_id', 'goods_num', 'member_discount', 'virtual_sales', 'mch_sort', 'type', 'is_level', 'confine_count', 'is_negotiable', 'attrbute_id','is_special','is_recommend','parent_id','is_attrbute_use'], 'integer'],
            ...
            [['detail', 'attr', 'cover_pic', 'full_cut', 'integral','attrbute_json'], 'string'],
            [['name', 'unit'], 'string', 'max' => 255],
            [['service','labels'], 'string', 'max' => 2000],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'parent_id' => '商品父类id，用于判断从平台商品哪个id来的',
            'store_id' => 'Store ID',
            'name' => '商品名称',
            'price' => '售价',
            ...
            'is_negotiable' => '面议方式',
            'attrbute_id' => '产品模型id',
            'attrbute_json' => '产品模型属性值参数',
            'is_special' => '是否是今日特价栏目 （0-否 1-是）',
            'is_recommend' => '是否推荐 (0-否 1-是)',
            'is_attrbute_use' => '是否设置规格参数 0-不设置 1-设置'
        ];
    }
