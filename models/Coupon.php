...
class Coupon extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'discount_type', 'expire_type', 'expire_day', 'begin_time', 'end_time', 'addtime', 'type','is_delete', 'total_count', 'is_join', 'sort','appoint_type','is_integral','integral','total_num','user_num','num','mch_id'], 'integer'],
     ...
     * @return boolean
     */
    public static function userAddCoupon($user_id, $coupon_id, $coupon_auto_send_id = 0, $type = 0,$mch_id = 0)
    {
