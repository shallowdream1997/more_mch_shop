 ...
 * @property string $anhour_api_text
...
class Order extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['store_id', 'user_id', 'order_no', 'order_sn', 'first_price', 'second_price', 'third_price'], 'required'],
            [['store_id', 'user_id', 'is_pay', 'pay_type', 'pay_time', 'is_send', 'send_time', 'is_confirm', 'confirm_time', 'is_comment', 'apply_delete', 'addtime', 'is_delete', 'is_price', 'parent_id', 'is_offline', 'clerk_id', 'is_cancel', 'shop_id', 'user_coupon_id', 'give_integral', 'parent_id_1', 'parent_id_2', 'is_sale', 'mch_id', 'is_recycle', 'order_union_id', 'is_transfer', 'type', 'is_show','is_remind', 'is_new_sale'], 'integer'],
            ...
            [['address_data', 'content', 'offline_qrcode', 'integral', 'words', 'seller_comments','anhour_api_text'], 'string'],
            [['order_no', 'order_sn', 'name', 'mobile', 'express', 'express_no', 'version'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'parent_id_2' => '用户上三级ID',
            'is_sale' => '是否超过售后时间',
            'is_new_sale' => '订单未发货是否售后同意 (0-否 1-是)',
            'words' => '商家留言',
            'version' => '版本',
            ...
            'currency' => '货币',
            'is_remind' => '是否提醒 (0-否 1-是)',
            'anhour_api_text' => '一小时对接订单返回消息',
        ];
    }
