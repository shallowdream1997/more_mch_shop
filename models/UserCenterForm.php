    ...
    public function getDefaultData()
    {
        ...
        $data = [
            ...
            'orders' => [
                ...
                'status_4' => [
                    'text' => '待评价',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-order-5.png',
                ],
            ],
            'menus' => [
                [
                ...
                [
                    ...
                    'open_type' => 'navigator',
                    'url' => '/step/drawback-list/drawback-list',
                    'tel' => '',
                ],
                [
                    'sign' => 'integralmall',
                ...
                [
                    'id' => 'pingjia',
                    'name' => '我的评价',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-user-pj.png',
                    'open_type' => 'navigator',
                    'url' => '/step/my-appraise/my-appraise',
                    'tel' => '',
                ],
                [
                    'id' => 'huiyuan',
                    'name' => '会员专享',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-user-member.png',
                    'open_type' => 'navigator',
                    'url' => '/pages/cart/cart',
                    'tel' => '',
                ],
