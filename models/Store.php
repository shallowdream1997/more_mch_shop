 ...
 * @property string $tencent_map
 * @property string $tencent_map_appid
 * @property integer $is_open_isv
 */
class Store extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tencent_map_appid' => '腾讯地图路线规划appid',
            'is_open_isv' => '是否开启用友接口',
        ];
    }
