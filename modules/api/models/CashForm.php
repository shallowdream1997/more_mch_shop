...
//            $cash->name = $this->name ? $this->name : \Yii::$app->user->identity->nickname;
            $cash->name = \Yii::$app->user->identity->nickname;
//            $cash->mobile = $this->mobile ? $this->mobile : \Yii::$app->user->identity->binding;
            $cash->mobile = \Yii::$app->user->identity->binding;
