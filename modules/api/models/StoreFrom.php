    ...
    public function search()
    {
        ...
        $images = [
            ...
            'share' => [
                ...
                'share_bg' => [
                    'url' => $wxappUrl . '/img-share-bg.png'
                ],
                'user_notice' => [
                    'url' => $wxappUrl. '/user-notice.png'
                ],
                'share_list_bg' => [
                    'url' => $wxappUrl. '/img-share-listbg.png'
                ],
            ],
            'shop' => [
                'dingwei' => [
                ...
                'icon_shop_hei' => [
                    'url' => $wxappUrl . '/icon-shop-hei.png'
                ],
                'icon_chat_hei' => [
                    'url' => $wxappUrl . '/icon-chat-hei.png'
                ],
                'icon_cat_hei' => [
                    'url' => $wxappUrl . '/icon-cat-hei.png'
                ],
                'icon_shop_red' => [
                    'url' => $wxappUrl . '/icon-shop-red.png'
                ],
                'icon_chat_red' => [
                    'url' => $wxappUrl . '/icon-chat-red.png'
                ],
                'icon_cat_red' => [
                    'url' => $wxappUrl . '/icon-cat-red.png'

                ],
                'icon_wechat' => [
                    'url' => $wxappUrl . '/icon-wechat.png'
                ]
            ],
            'sort' => [
                'down' => [
            ...
            'goods' => [
                'goods' => [
                    ...
                    'home_icon' => [
                        'url' => $wxappUrl . '/home.png'
                    ],
                    'cart_icon' => [
                        'url' => $wxappUrl . '/cart.png'
                    ],
                    'share_icon' => [
                        'url' => $wxappUrl . '/share.png'
                    ],
                    'user_icon' => [
                        'url' => $wxappUrl . '/user.png'
                    ],
                    'three_bars_icon' => [
                        'url' => $wxappUrl . '/three-bars.png'
                    ]
                ]
            ],
            'step' => [
