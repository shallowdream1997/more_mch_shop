...
class OrderDetailForm extends ApiModel
{
        ...
        return [
            ...
            'data' => [
                'order' => [
                    ...
                    'words' => $order->words,
                    'mch_list' => $this->mchlist($order->mch_id),
                ],
            ],
        ];
    }

    public function mchlist($mch_id)
    {
    ...
    public function delorder()
    {
        ...
        $order = Order::findOne(['id' => $this->id, 'mch_id' => $this->mch_id,'is_delete'=>0,'is_cancel'=>0,'apply_delete'=>0]);
