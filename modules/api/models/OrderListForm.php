...
//            'is_delete' => 0,
        ...
        if ($this->status == 2) {//待收货
            ...
            $query->andWhere(['and',['or','isnull(of.id)',['of.status'=>3]]]);
        }
        ...
        /* @var Order[] $list */
        $list = $query->limit($pagination->limit)->offset($pagination->offset)->orderBy('o.addtime DESC')->all();
        $new_list = [];
