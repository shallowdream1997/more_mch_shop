    ...
    public function save()
    {
        ...
        if ($order->save()) {
            ...
            if ($this->pay_type == 'WECHAT_PAY') {
                ...
                //对接一小时用户钱包充值系统 start
                $data = [
                    'membership_info_id' => $this->user->membership_info_id,
                    'transaction_id' => $this->order->order_no,
                    'pay_money' => $this->order->pay_price,
                    'recharge_money' => $this->pay_price,
                    'extra_money' => $this->send_price,
                    'pay_type' => 'wechat cash',
                ];
                $resD = new CommonCurlAnhour();
                $resD->type = "POST";
                $resD->url = "storemall/user/recharge";
                $resD->data = $data;
                $resD->selectType();
                //对接一小时用户钱包充值系统 end
