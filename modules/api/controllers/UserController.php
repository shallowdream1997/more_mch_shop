...
use app\modules\api\models\UserSaveForm;
...
//        $user_center_menu->store_id = $this->store->id;
        ...
        $coupon = new CouponIndexForm();
        $coupon->store_id = $this->store->id;
        $coupon->user_id = \Yii::$app->user->id;
        $coupon_list = $coupon->indexcoupon();

        $icon_list = [
            'vip' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/vip.png',
            'vip_footer' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/vip-footer.png',
            'vip_header' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/vip-header.png',
            'icon_user_yhq' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-user-yhq.png',
            'icon_user_pj' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-user-pj.png',
            'icon_user_gj' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-user-gj.png',
            'icon_order_5' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-order-5.png',
            'img_user_bg' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/img-user-bg.png',
            'coupon_bg' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/coupon.png',
        ];
...
//                'menu_list' => $user_center_menu->getMenuList(),
                ...
                'wallet' => $wallet,
                'coupon_list' => $coupon_list['data']['list'],
                'style' => [
    ...
    {
        $address = Address::find()->select('id,name,mobile,province_id,province,city_id,city,district_id,district,detail,is_default,email_code')->where([
            'store_id' => $this->store->id,
            'user_id' => \Yii::$app->user->id,
            'is_delete' => 0,
...
//检测是否绑定公众号
    ...
    {
        $user = User::find()->select('id,nickname,binding,sex,avatar_url,birthday')->where([
            'store_id' => $this->store->id,
            'id' => \Yii::$app->user->id,
            'is_delete' => 0
        ])->one();
