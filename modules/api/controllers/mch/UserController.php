...
use app\modules\api\models\mch\ChangeMchForm;
...
use app\modules\api\models\mch\TongjiYearDataForm;
...
class UserController extends Controller
{
    ...
    public function actionShopDetail()
    {
        $form = new SettingForm();
        $form->mch = $this->mch;
        return new BaseApiResponse($form->getMchshop());
    }

    //切换门店
    public function actionMchChangelist()
    {
        $form = new ChangeMchForm();
        $form->mch = $this->mch;
        return new BaseApiResponse($form->search());
    }
    ...
    public function actionChangeMch()
    {
        $form = new ChangeMchForm();
        $form->attributes = \Yii::$app->request->get();
        $form->mch = $this->mch;
        return new BaseApiResponse($form->changemch());
    }
    ...
    public function actionTongjiYearData()
    {
        $form = new TongjiYearDataForm();
        $form->attributes = \Yii::$app->request->get();
        $form->mch_id = $this->mch->id;
        return new BaseApiResponse($form->search());
    }
    ...
    public function actionNoSettleLog()
    {
        $form = new AccountLogForm();
        $form->attributes = \Yii::$app->request->get();
        $form->mch_id = $this->mch->id;
        return new BaseApiResponse($form->nosettleLog());
    }

    public function actionCashNew()
    {
        $form = new CashSubmitForm();
        $form->attributes = \Yii::$app->request->post();
        $form->mch_id = $this->mch->id;
        return new BaseApiResponse($form->savenew());
    }
}
