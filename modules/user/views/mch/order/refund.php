    ...
    <div class="panel-body">
        ...
        <table class="table table-bordered bg-white">
            <tr>
                ...
                <th class="order-tab-2">退款退货|退款</th>
                ...
                <table class="table table-bordered bg-white">
                    ...
                    <tr>
                        ...
                        <td class="order-tab-2">
                            ...
                            <?php endif; ?>
                            <?php if ($order_item['refund_type'] == 3) : ?>
                                <div class="orderTitle">售后类型：<span class="badge badge-primary">退款</span></div>
                                <div class="orderTitle">退款金额：<span class="text-danger"><?= $order_item['refund_price'] ?></span>元</div>
                                <div><span class="orderTitle">申请理由：</span><?= $order_item['refund_desc'] ?></div>
                                <div><span class="orderTitle">货物状态：</span><?= $order_item['re_status'] ?></div>
                                <div><span class="orderTitle">退款原因：</span><?= $order_item['re_rea'] ?></div>
                                <div class="img-view-list">
                                    <?php $pic_list = json_decode($order_item['refund_pic_list']) ?>
                                    <?php if (is_array($pic_list)) :
                                        foreach ($pic_list as $pic) : ?>
                            ...
                            <?php if ($order_item['refund_status'] == 0) : ?>
                                <?php if ($order_item['refund_type'] == 3) : ?>
                                    <div class="mb-2">
                                        <a href="javascript:" class="btn btn-sm btn-success agree-btn-1"
                                           ...
                                           data-price="<?= $order_item['refund_price'] ?>">同意退款</a>
                                    </div>
                                    <div class="mb-2">
                                        <a href="javascript:" class="btn btn-sm btn-danger disagree-btn-1"
                                           data-id="<?= $order_item['order_refund_id'] ?>">拒绝退款</a>
                                    </div>
                                <?php elseif($order_item['refund_type'] == 2) : ?>
                                    <div class="mb-2">
                                ...
                                <?php else : ?>
                                    <?php if ($order_item['is_agree'] == 1) : ?>
                                        ...
                                        <?php else : ?>
                                            <div class="mb-2">
                                                <a href="javascript:" class="btn btn-sm btn-danger disagree-btn-3"
                                                   data-id="<?= $order_item['order_refund_id'] ?>">拒绝退货</a>
                                            </div>
                                        <?php endif; ?>
                                        <div class="mb-2">
                                            <a href="javascript:" class="btn btn-sm btn-success agree-btn-4"
                                               data-id="<?= $order_item['order_refund_id'] ?>"
                                    ...
                                    <?php else : ?>
                                        <div class="mb-2">
                                            <a href="javascript:" class="btn btn-sm btn-success"
                                               data-toggle="modal" data-target="#retreatModal1"
...
<!-- 退货 -->
<div class="modal fade" id="retreatModal1" data-backdrop="static">
...
<script>
    ...
    //确认收货，退款
    $(document).on('click', '.agree-btn-4', function () {
        var id = $(this).attr("data-id");
        var price = $(this).attr("data-price");
        $.myConfirm({
    ...
    //拒绝退货退款
    var orderRefundId = '';
    $(document).on("click", ".disagree-btn-3", function () {
