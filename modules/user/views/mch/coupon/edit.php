...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form class="form auto-form" method="post" autocomplete="off" return="<?= $urlManager->createUrl(['user/mch/coupon/edit','id' => $model->id]) ?>">
            <div class="form-body">
...
<script>
    ...
    function search_cat() {
        ...
        btn.btnLoading("正在查找");
        $.ajax({
            url: "<?=$urlManager->createUrl(['user/mch/coupon/search-cat'])?>",
            dataType: "json",
            data: {
                keyword: keyword,
            },
    ...
    function search_goods() {
        ...
        btn.btnLoading("正在查找");
        $.ajax({
            url: "<?=$urlManager->createUrl(['user/mch/coupon/search-goods'])?>",
            dataType: "json",
            data: {
                keyword: keyword,
            },
