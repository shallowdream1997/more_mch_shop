    ...
    <div class="panel-body">
        <form class="auto-form" method="post" return="<?= $urlManager->createUrl(['user/mch/goods/cat']) ?>">
            ...
            <div class="advert" <?= empty($list['parent_id']) ? '' : 'style="display:none"' ?>>
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-2 text-right">
                        <label class="col-form-label">分类展示方式</label>
                    </div>
                    <div class="col-sm-6">
                        <label class="radio-label">
                            <input id="radio1" <?= $list['type'] == 0 ? 'checked' : 'checked' ?>
                                   value="0"
                                   name="model[type]" type="radio" class="custom-control-input">
                            <span class="label-icon"></span>
                            <span class="label-text">无</span>
                        </label>
                        <label class="radio-label">
                            <input id="radio2" <?= $list['type'] == 1 ? 'checked' : null ?>
                                   value="1"
                                   name="model[type]" type="radio" class="custom-control-input">
                            <span class="label-icon"></span>
                        ...
                        <label class="radio-label">
                            <input id="radio2" <?= $list['type'] == 2 ? 'checked' : null ?>
                                   value="2"
                                   name="model[type]" type="radio" class="custom-control-input">
                            <span class="label-icon"></span>
                            <span class="label-text">大图广告</span>
                        </label>
                    </div>
                </div>
            </div>
