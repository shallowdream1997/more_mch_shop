...
<table class="table table-bordered bg-white">
    <tr>
        ...
        <th class="order-tab-5" colspan="3">门店分销</th>
        <th class="order-tab-5" colspan="3">店员分销</th>
        <!--<th class="order-tab-5" colspan="3">自购返利</th>-->
    </tr>
</table>
                    ...
                    <div flex="dir:left">
                        <?php if ($order_item['share']): ?>
                            <div class="p-2 text-left">
                                <span>门店名称：<?= $order_item['share']['name'] ?></span>
                                <span class="ml-3"><?= $order_item['share']['service_tel'] ? "客服电话：" . $order_item['share']['service_tel'] : "" ?></span>
                                <div class="titleColor">一级佣金：<span style="color:red;"><?= floatval($order_item['first_price']) ?></span>元
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <td class="order-tab-6">
                    <div flex="dir:left">
                        <?php if ($order_item['share_1']) : ?>
                            <div class="p-2 text-left">
                                <span>店员昵称：<?= $order_item['share_1']['nickname'] ?></span>
                                ...
                                <div class="titleColor">二级佣金：<span style="color:red;"><?= floatval($order_item['second_price']) ?></span>元
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                </td>
                <!--<td class="order-tab-7">
