    ...
    <div class="panel-body">
        <form method="post" class="auto-form">
            <div id="content1">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-2 text-right">
                        <label class="col-form-label">腾讯地图 KEY</label>
                    </div>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="tencent_map"
                               value="<?= $store->tencent_map ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="form-group-label col-sm-2 text-right">
                        <label class="col-form-label">腾讯地图路线规划 appid</label>
                    </div>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="tencent_map_appid"
                               value="<?= $store->tencent_map_appid ?>">
                    </div>
                </div>
<!--
                <div class="form-group row">
...
-->
                <div class="form-group row">
                    <div class="form-group-label col-sm-2 text-right">
                        <label class="col-form-label">用友系统开启</label>
                    </div>
                    <div class="col-sm-6">
                        <label class="radio-label">
                            <input id="radio1" <?= $store->is_open_isv == 0 ? 'checked' : null ?>
                                   value="0"
                                   name="is_open_isv" type="radio" class="custom-control-input">
                            <span class="label-icon"></span>
                            <span class="label-text">关闭</span>
                        </label>
                        <label class="radio-label">
                            <input id="radio1" <?= $store->is_open_isv == 1 ? 'checked' : null ?>
                                   value="1"
                                   name="is_open_isv" type="radio" class="custom-control-input">
                            <span class="label-icon"></span>
                            <span class="label-text">开启</span>
                        </label>
                        <div class="text-muted fs-sm">开启用友接口，则对接isv用友系统，</a>
                        </div>
                    </div>
                </div>
