...
<div id="one_menu_bar">
    <div id="tab_bar">
        <ul>
            ...
            <li class="tab_bar_item" <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?> id="tab4" onclick="myclick(4)">
                产品规格参数设置
            </li>
        </ul>
    </div>
                            ...
                            <div class="step-block" flex="dir:left box:first">
                                ...
                                <div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input hidden type="text" value="<?= $goods['id'] ?>" class="input_goods_id">
                                           ...
                                           data-placement="bottom" title="删除文件">
                                            <span class="iconfont icon-close"></span>
                                                ...
                                                <div class="upload-preview text-center upload-preview">
                                                    <span class="upload-preview-tip">11：9</span>
                                                    ...
                                                    <?php if (count($goods_pic_list) > 0) : ?>
                                                        <?php foreach ($goods_pic_list as $item) : ?>
                                                            <div class="upload-preview text-center" flex="cross:center">
                                                                ...
                                                                <span class="upload-preview-tip">750&times;480</span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control short-row" name="model[labels]"
                                                   value="<?= $goods['labels'] ?>">
                                    ...
                                    <div <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?> class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <label class="radio-label">
                                                <input <?= $goods['is_special'] == 0 ? 'checked' : null ?>
                                                        value="0" name="model[is_special]" type="radio"
                                                        class="custom-control-input">
                                                <span class="label-icon"></span>
                                                <span class="label-text">否</span>
                                            </label>
                                            <label class="radio-label">
                                                <input <?= $goods['is_special'] == 1 ? 'checked' : null ?>
                                                        value="1" name="model[is_special]" type="radio"
                                                        class="custom-control-input">
                                                <span class="label-icon"></span>
                                    ...
                                    <div <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?> class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <label class="radio-label">
                                                <input <?= $goods['is_recommend'] == 0 ? 'checked' : null ?>
                                                        value="0" name="model[is_recommend]" type="radio"
                                                        class="custom-control-input">
                                                <span class="label-icon"></span>
                                                <span class="label-text">关闭</span>
                                            </label>
                                            <label class="radio-label">
                                                <input <?= $goods['is_recommend'] == 1 ? 'checked' : null ?>
                                                        value="1" name="model[is_recommend]" type="radio"
                                                        class="custom-control-input">
                                                <span class="label-icon"></span>
                                                <span class="label-text">开启</span>
                                            </label>
            ...
            <div class="tab_css" id="tab4_content">
                ...
                <div <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?> class="step-block" flex="dir:left box:first">
                    ...
                    <div>
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class=" col-form-label">是否设置规格参数</label>
                            </div>
                            <div class="col-9 col-form-label">
                                <label class="radio-label">
                                    <input <?= $goods['is_attrbute_use'] == 0 ? 'checked' : null ?>
                                            value="0" name="model[is_attrbute_use]" type="radio"
                                            class="custom-control-input">
                                    <span class="label-icon"></span>
                                    <span class="label-text">不设置</span>
                                </label>
                                <label class="radio-label">
                                    <input <?= $goods['is_attrbute_use'] == 1 ? 'checked' : null ?>
                                            value="1" name="model[is_attrbute_use]" type="radio"
                                            class="custom-control-input">
                                    <span class="label-icon"></span>
                ...
                <!-- 快速购买结束 -->
                <div class="is-attr-use">
                    <?= $this->render('/layouts/attrs/attrvalue_model_goods',[
                            'goods' => $goods,
...
<script>
    ...
    //getAttrValueReadyList();
    //function getAttrValueReadyList()
    //{
    //    $("#attrtype").ready(function () {
    //        var index=$('.addattr').val();
    //        console.log(index);
    //        $.ajax({
    //            url: "<?//= $urlManager->createUrl(['mch/goods/get-attr-value'])?>//",
    //            type: 'get',
    //            dataType: "json",
    //            data: {attr_id: index},
    //            success: function (res) {
    ...
    function getModelsList() {
        var goods_id = $('.input_goods_id').val();
        var models_id = $('.addattr').val();
        page.sub_cat_list = [];
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/goods/get-models-list'])?>",
            data: {
                goods_id: goods_id,
                models_id: models_id,
            },
            success: function (res) {
                if (res.code == 0) {
                    console.log(res.data);
                    page.model_group_list = res.data;
                }
            }
        });
    }
    ...
    $(document).on("change", "input[name='model[is_attrbute_use]']", function () {
        setIsAttrbuteUse();
    });
    setIsAttrbuteUse();

    function setIsAttrbuteUse() {
        if ($("input[name='model[is_attrbute_use]']:checked").val() == 1) {
            $(".is-attr-use").show();
        } else {
            $(".is-attr-use").hide();
        }
