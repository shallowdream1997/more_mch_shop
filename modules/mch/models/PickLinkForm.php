            ...
            [
                ...
                'params' => [
                    ...
                    [
                        'key' => "shop_id",
                        'value' => "",
                        'desc' => "shop_id 即进入门店的id"
                    ],
                    [
                        'key' => "mch_name",
                        'value' => "",
                        'desc' => "mch_name 请填写进入门店的名称"
                    ],
                    [
                        'key' => "tencent_map_key",
                        'value' => \Yii::$app->store->tencent_map,
                        'desc' => "tencent_map_key 即为腾讯地图key，方便进入店铺详情调用地图"
                    ],
                    [
                        'key' => "type",
                        'value' => 0,
                        'desc' => "type 进入产品专区该值固定为 0 "
                    ],
                ]
            ],
            [
...
//            [
//                'name' => "门店现货",
//                'link' => "/pages/product-prefecture/product-prefecture",
//                'open_type' => "navigate",
//                'params' => [
//                    [
//                        'key' => "mch_id",
//                        'value' => "",
//                        'desc' => "mch_id请填写在商户列表中相关商户的ID"
//                    ],
//                    [
//                        'key' => "link",
//                        'value' => "",
//                        'desc' => "link 填写 1 是进入现货，不填即进入专区"
//                    ]
//                ]
//            ],
            [
                'name' => "门店现货",
                'link' => "/pages/shop-goods/shop-goods",
                'open_type' => "navigate",
                'params' => [
//                    [
//                        'key' => "mch_id",
