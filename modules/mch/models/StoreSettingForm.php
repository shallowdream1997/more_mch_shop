...
class StoreSettingForm extends MchModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['order_send_tpl', 'contact_tel', 'kdniao_mch_id', 'kdniao_api_key', 'address', 'service', 'integration', 'notice', 'web_service', 'web_service_url', 'logo', 'web_service_status','tencent_map'], 'string'],
            [['show_customer_service', 'cat_style', 'cut_thread', 'purchase_frame', 'is_recommend', 'cat_goods_cols', 'is_offline', 'is_coupon', 'cat_goods_count', 'send_type', 'nav_count', 'dial', 'is_comment', 'is_sales', 'phone_auth', 'buy_member', 'mobile_verify', 'web_service_status', 'is_open_isv'], 'integer', 'max' => 99999999],
    ...
    public function save()
    {
        ...
        $store->tencent_map = $this->tencent_map;
        $store->is_open_isv = $this->is_open_isv;
        $store->save();
