...
class SettingForm extends MchModel
{
    ...
    {
        return [
            [['status', 'pic_url', 'ad_pic_url', 'page_url', 'help', 'p_pic_url','type','wechat_pay'], 'trim'],
            [['status', 'pic_url', 'ad_pic_url', 'page_url', 'help', 'p_pic_url','type','wechat_pay'], 'string'],
        ];
    }
    ...
    public function save()
    {
        ...
        $list['wechat_pay'] = $this->wechat_pay;
        $list['help'] = $this->help;
        $list['type'] = $this->type;
