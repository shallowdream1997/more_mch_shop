...
class GoodsSearchForm extends MchModel
{
    ...
    public function search()
    {
        ...
        $modelsList = AttrModel::find()->where(['store_id' => $this->store->id,'is_use' => 1,'mch_id'=>0])->all();
        if ($goods->full_cut) {
        ...
        $modelList = AttrModel::findOne(['id' => $goods->attrbute_id, 'store_id' => $this->store->id, 'mch_id' => 0]);
